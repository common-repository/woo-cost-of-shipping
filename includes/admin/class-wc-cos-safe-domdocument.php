 ...
 */
class WC_COS_Safe_DOMDocument extends DOMDocument {
	/**
	...
	public function load( $filename, $options = 0 ) {
		if ( '' === $filename ) {
			...
			trigger_error( 'WC_COS_Safe_DOMDocument::load(): Empty string supplied as input', E_USER_WARNING );
			return false;
		}
		...
		if ( ! is_file( $filename ) || ! is_readable( $filename ) ) {
			...
			trigger_error( 'WC_COS_Safe_DOMDocument::load(): I/O warning : failed to load external entity "' . $filename . '"', E_USER_WARNING );
			return false;
		}
	...
	public function loadXML( $source, $options = 0 ) {
		if ( '' === $source ) {
			...
			// "This warning is not generated by libxml and cannot be handled using libxml's error handling functions."
			trigger_error( 'WC_COS_Safe_DOMDocument::loadXML(): Empty string supplied as input', E_USER_WARNING );
			return false;
		}
		...
		if ( isset( $object->doctype ) ) {
			...
			trigger_error( 'WC_COS_Safe_DOMDocument::loadXML(): Unsafe DOCTYPE Detected', E_USER_WARNING );
